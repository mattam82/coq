...
type 'a obj_interp_fun =
  ?loc:Loc.t -> poly:SortPolyFlags.t -> t -> Evd.evar_map -> Evardefine.type_constraint ->
...
val interp_glob_genarg : ?loc:Loc.t -> poly:SortPolyFlags.t -> t -> evar_map -> Evardefine.type_constraint ->
