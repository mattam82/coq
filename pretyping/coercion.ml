...
let inh_conv_coerce_to_gen resolve_tc rigidonly flags loc env evd cj t =
  let (evd', val') =
    try
...
let inh_conv_coerce_to resolve_tc loc env evd ?(flags=default_flags_of env) =
  inh_conv_coerce_to_gen resolve_tc false flags loc env evd
let inh_conv_coerce_rigid_to resolve_tc loc env evd ?(flags=default_flags_of env) =
  inh_conv_coerce_to_gen resolve_tc true flags loc env evd
