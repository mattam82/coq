...
(** [try_add_new_coercion_with_target ref s src tg] declares [ref] as a coercion
   from [src] to [tg] *)
val try_add_new_coercion_with_target : global_reference -> local:bool -> polymorphic ->
...
val try_add_new_coercion : global_reference -> local:bool -> polymorphic -> unit
...
(** [try_add_new_coercion_subclass cst s] expects that [cst] denotes a
   ...
   ["Id_cst_tg"] *)
val try_add_new_coercion_subclass : cl_typ -> local:bool -> polymorphic -> unit
...
val try_add_new_coercion_with_source : global_reference -> local:bool -> polymorphic ->
  source:cl_typ -> unit
...
val try_add_new_identity_coercion : Id.t -> local:bool -> polymorphic ->
  source:cl_typ -> target:cl_typ -> unit
