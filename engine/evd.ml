...
let check_sort_poly_decl ~poly ~cumulative ~kind evd decl =
  UState.check_sort_poly_decl ~poly ~cumulative ~kind evd.universes decl

let check_sort_poly_decl_early ~poly ~cumulative ~with_obls sigma udecl terms =
  let () =
  ...
  ignore (UState.check_sort_poly_decl ~poly ~cumulative ~kind:(UVars.Assumption) uctx udecl)
