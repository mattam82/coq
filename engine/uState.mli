...
val univ_entry : poly:SortPolyFlags.t -> ?variances:Entries.variance_declaration_entry -> t -> named_universes_entry
...
(** [check_sort_poly_decl ctx decl]
   ...
   list. *)
val check_sort_poly_decl : poly:SortPolyFlags.t -> kind:SortPolyFlags.assumption_or_definition ->
  t -> sort_poly_decl -> named_universes_entry
