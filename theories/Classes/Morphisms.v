...
(* We infer the equality relation only on types which are not arities.
  Unless one assumes propositional extensionality or univalence, the
...
Ltac reflexive_proxy_tac A R :=
  tryif has_evar R then
    ...
    find_rewrite_relation A R ltac:(fun RA =>
      ...
      (* Ths Reflexive subgoal produced here will need no backtracking,
