...
val interp_constr_evars_impls : ?program_mode:bool -> ?poly_flags:SortPolyFlags.t -> env -> evar_map ->
  ?impls:internalization_env -> constr_expr ->
  evar_map * (constr * Impargs.manual_implicits)

val interp_casted_constr_evars_impls : ?program_mode:bool -> ?poly_flags:SortPolyFlags.t -> env -> evar_map ->
...
val interp_context_evars :
  ?program_mode:bool -> ?unconstrained_sorts:bool -> ?poly_flags:SortPolyFlags.t -> ?impl_env:internalization_env ->
...
val interp_named_context_evars :
  ?program_mode:bool -> ?unconstrained_sorts:bool -> ?poly_flags:SortPolyFlags.t -> ?impl_env:internalization_env -> ?autoimp_enable:bool ->
  env -> evar_map -> local_binder_expr list ->
