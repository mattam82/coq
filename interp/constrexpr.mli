...
type sort_poly_decl_expr = (lident list, elim_constraint_expr list, lident list, (UVars.Variance.t option) list option, univ_constraint_expr list) UState.gen_sort_poly_decl
