...
| subst_tm : forall {Γ Δ} {A : Ty Δ} (t : Tm Δ A) (δ : Sub Γ Δ), Tm Γ (subst_ty _ _ A δ)
| π2 : forall {Γ Δ} {A : Ty Δ} (δ : Sub Γ (ctx_ext Δ A)), Tm Γ (subst_ty _ _ A (π1 _ _ _ δ))
| app : forall {Γ} {A : Ty Γ} {B : Ty (ctx_ext Γ A)}, Tm Γ (Pi _ A B) -> Tm (ctx_ext Γ A) B
| lam : forall {Γ} {A : Ty Γ} {B : Ty (ctx_ext Γ A)}, Tm (ctx_ext Γ A) B -> Tm Γ (Pi _ A B)
.
