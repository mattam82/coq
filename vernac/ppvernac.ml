...
let pr_sort_poly_decl_instance l v extensible =
...
let pr_universe_decl l =
  ...
  | Some l ->
    ...
    pr_sort_poly_decl_instance l.sort_poly_decl_instance l.sort_poly_decl_variances l.sort_poly_decl_extensible_instance ++
